...
export class ImageEditor extends React.Component {
    ...
    render() {
        ...
        this.divStyle = {
            backgroundImage: 'url(' + store.editImage + ')'
        }
        return (
            <rebo.Row id="canvasEditor" className='align-selft-start' style={this.divStyle}>
                <p.View
                    ref={this.paperView}
                    width={width}
                    height={height}
                ...
                <rebo.Button onClick={this.saveLayout}>Save</rebo.Button>
            </rebo.Row>
        );
    }
}
